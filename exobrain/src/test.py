...
def test_test(tmp_data: Path, tmp_path: Path) -> None:
    d = tmp_data
    i      = d / 'input'
    public = d / 'public'
    html   = d / 'html'
    ...
    # shouldn't contain id in this div
    assert '<div class="outline-text-2">' in test_html

    assert '<a class="headerlink" href="#smtds">¶</a>' in test_html
...
def test_build_some(tmp_data: Path, tmp_path: Path) -> None:
    ...
    def run_build(*args):
        check_call(build('--data-dir', d, *args))
